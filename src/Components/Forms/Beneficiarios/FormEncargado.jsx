...
function FormEncargado({idBene, showComponent }) {
 ...
 const guardarBeneAndEncargado = (e) =>{
  ...
  return (
    <div hidden={showComponent} id="FormDatosEncargado" className={showComponent ? '' : styles.Container}>
      {isEncargado ? (
        <div className={styles.Container}>
          ...
          <form onSubmit={dataSend} className={styles.Grid}>
            ...
            {showNext ? (
              <div className={styles.Grid__button}>
                <button onClick={showOtherComponent} id="button-Encargado" className="Button Button--Guardar">
                  <div className="Button__Icono">
